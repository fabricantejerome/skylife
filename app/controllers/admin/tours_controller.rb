class Admin::ToursController < AdminController
  ...
  private
    ...
    def admin_tour_params
      params.require(:tour).permit(:package, :price_per_head, :name, :location, :promo, :inclusion, :exclusion, :travel_date, :terms_and_condition, :notes, :meta_title, :meta_description, :keywords, :google_analytics_tracking_id, :conversion_tracking_setup, :facebook, :instagram, :tiktok, :category_id, :featured_image, :banner_image, :itinerary, :external_link, gallery_images: [])
    end
end
